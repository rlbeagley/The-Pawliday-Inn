...
export default function About() {
  return (
    <Container className="d-flex flex-column justify-content-center align-items-center text-center" style={{ minHeight: '100vh', paddingTop: '40px' }}>
      ...
      <Row className="justify-content-center">
        <Col xs={12} md={8}>
          ...
          <p>Contact us at this number: <b>613-253-2957</b></p>
